...
namespace GymManagementSystem_DAL.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidPhoneCheck", "Phone LIKE '03%' and Phone Not Like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidPhoneCheck1", "Phone LIKE '03%' and Phone Not Like '%[^0-9]%'");
                });
